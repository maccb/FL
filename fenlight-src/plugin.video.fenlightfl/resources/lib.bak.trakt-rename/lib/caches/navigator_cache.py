...
class NavigatorCache:
	...
	def random_fl_lists_personal(self):
		return [
			...
			{'mode': 'random.build_fl_lists', 'list_type': 'my_lists', 'name': 'Random FL My Lists (Single)', 'iconImage': 'trakt', 'random': 'true'},
			{'mode': 'fl.list.get_fl_lists', 'list_type': 'liked_lists', 'name': 'Random Shuffled FL Liked Lists (All)',
			'iconImage': 'trakt', 'random': 'true', 'shuffle': 'true'},
			{'mode': 'random.build_fl_lists', 'list_type': 'liked_lists', 'name': 'Random FL Liked Lists (Single)', 'iconImage': 'trakt', 'random': 'true'},
				]
