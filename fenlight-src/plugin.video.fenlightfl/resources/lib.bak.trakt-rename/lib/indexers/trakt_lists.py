...
def search_fl_lists(params):
	...
	handle, search_title, fl_icon, fanart = int(sys.argv[1]), '', kodi_utils.get_icon('trakt'), kodi_utils.get_addon_fanart()
...
def get_fl_lists(params):
	...
	handle, fl_icon, fanart = int(sys.argv[1]), kodi_utils.get_icon('trakt'), kodi_utils.get_addon_fanart()
	try:
