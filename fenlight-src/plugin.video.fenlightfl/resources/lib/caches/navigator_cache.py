...
class NavigatorCache:
	...
	def random_tvshow_lists(self):
		...
		tvshow_random_converts = {'navigator.genres': 'tmdb_tv_genres', 'navigator.providers': 'tmdb_tv_providers', 'navigator.networks': 'tmdb_tv_networks',
								...
								'navigator.certifications': 'fl_tv_certifications'}
	...
	def random_anime_lists(self):
		...
		anime_random_converts = {'navigator.genres': 'tmdb_anime_genres', 'navigator.providers': 'tmdb_anime_providers', 'navigator.years': 'tmdb_anime_year',
								'navigator.decades': 'tmdb_anime_decade', 'navigator.certifications': 'fl_anime_certifications'}
	...
	def random_fl_lists_personal(self):
		return [
			{'mode': 'random.build_movie_list', 'action': 'fl_collection_lists', 'name': 'Random FL Movie Collection', 'iconImage': 'movies', 'random': 'true'},
			{'mode': 'random.build_tvshow_list', 'action': 'fl_collection_lists', 'name': 'Random FL TV Show Collection', 'iconImage': 'tv', 'random': 'true'},
			{'mode': 'random.build_movie_list', 'action': 'fl_watchlist_lists', 'name': 'Random FL Movie Watchlist', 'iconImage': 'movies', 'random': 'true'},
			{'mode': 'random.build_tvshow_list', 'action': 'fl_watchlist_lists', 'name': 'Random FL TV Show Watchlist', 'iconImage': 'tv', 'random': 'true'},
			{'mode': 'random.build_movie_list', 'action': 'fl_recommendations', 'new_page': 'movies', 'name': 'Random FL Recommended Movies',
			'iconImage': 'movies', 'random': 'true'},
			{'mode': 'random.build_tvshow_list', 'action': 'fl_recommendations', 'new_page': 'shows', 'name': 'Random FL Recommended TV Shows',
			'iconImage': 'tv', 'random': 'true'},
			{'mode': 'fl.list.get_fl_lists', 'list_type': 'my_lists', 'name': 'Random Shuffled FL My Lists (All)',
			'iconImage': 'fl', 'random': 'true', 'shuffle': 'true'},
			{'mode': 'random.build_fl_lists', 'list_type': 'my_lists', 'name': 'Random FL My Lists (Single)', 'iconImage': 'fl', 'random': 'true'},
			{'mode': 'fl.list.get_fl_lists', 'list_type': 'liked_lists', 'name': 'Random Shuffled FL Liked Lists (All)',
			'iconImage': 'fl', 'random': 'true', 'shuffle': 'true'},
			{'mode': 'random.build_fl_lists', 'list_type': 'liked_lists', 'name': 'Random FL Liked Lists (Single)', 'iconImage': 'fl', 'random': 'true'},
				]

	def random_fl_lists_public(self):
		return [
			{'mode': 'fl.list.get_fl_user_lists', 'list_type': 'trending', 'category_name': 'Random Trending User Lists', 'name': 'Random Trending User Lists (All)',
			'iconImage': 'fl', 'random': 'true'},
			{'mode': 'random.build_fl_lists', 'list_type': 'trending', 'category_name': 'Random Trending User Lists', 'name': 'Random Trending User Lists (Single)',
			'iconImage': 'fl', 'random': 'true'},
			{'mode': 'fl.list.get_fl_user_lists', 'list_type': 'popular', 'category_name': 'Random Popular User Lists', 'name': 'Random Popular User Lists (All)',
			'iconImage': 'fl', 'random': 'true'},
			{'mode': 'random.build_fl_lists', 'list_type': 'popular', 'category_name': 'Random Popular User Lists', 'name': 'Random Popular User Lists (Single)',
			'iconImage': 'fl', 'random': 'true'}
				]
